...
-(void)setHomeView{
    ...
    mvc.title=@"我";
    UITabBarItem*item1=[[UITabBarItem alloc]initWithTitle:@"找师傅" image: [UIImage imageNamed:@"找师傅-未选中"] selectedImage: [UIImage imageNamed:@"找师傅-选中"]];
    UITabBarItem*item2=[[UITabBarItem alloc]initWithTitle:@"找活干" image: [UIImage imageNamed:@"订单-未选中"] selectedImage: [UIImage imageNamed:@"订单-选中"]];
