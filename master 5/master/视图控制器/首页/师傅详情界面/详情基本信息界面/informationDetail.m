...
//     NSArray *constraint1 = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-35-[ self.orderButton(==40)]" options:0 metrics:nil views:NSDictionaryOfVariableBindings( self.orderButton)];
//    
//    NSArray*constraints=[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-10-[self.orderButton]-10-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(self.orderButton)];
//   
//    NSArray*constraints2=[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-[self.tableview]-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(self.tableview)];
//    NSArray*constraints3=[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-[self.tableview]-[self.orderButton(==40)]-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(self.tableview,self.orderButton)];
...
//    }
//    view=[[UIView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH-120, 44)];
//    view.backgroundColor=[UIColor whiteColor];
//    view.userInteractionEnabled=YES;
//    view.tag=10;
//    UILabel*label=[[UILabel alloc]initWithFrame:CGRectMake(10, 5, 120, 20)];
//    label.textColor=COLOR(201, 201, 201, 1);
...
//        }
//        
//        if ([self accountStringHeightFromString:adressStr Width:SCREEN_WIDTH-110]>16) {
//            return [self accountStringHeightFromString:adressStr Width:SCREEN_WIDTH-110]+10;
//        }
//        return 44;
//        
//    }
